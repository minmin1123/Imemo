...
public class TickView extends View {
    ...
    private void initAttrs(AttributeSet attrs) {
        ...
        mConfig.setUnCheckBaseColor(typedArray.getColor(R.styleable.TickView_uncheck_base_color, getResources().getColor(R.color.line_gray)))
                .setCheckBaseColor(typedArray.getColor(R.styleable.TickView_check_base_color, getResources().getColor(R.color.theme_orange)))
                .setCheckTickColor(typedArray.getColor(R.styleable.TickView_check_tick_color, getResources().getColor(R.color.bg_gray)))
                .setRadius(typedArray.getDimensionPixelOffset(R.styleable.TickView_radius, dp2px(12)))
                .setClickable(typedArray.getBoolean(R.styleable.TickView_clickable, true))
                .setTickRadius(dp2px(6))
                .setTickRadiusOffset(dp2px(1));
        ///配置ticview的动画速率
